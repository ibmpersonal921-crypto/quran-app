"""
app_pages/0_🏠_Home.py
-----------------------
The Home / Dashboard page — registered with a proper "Home" title + icon
via st.navigation() in app.py, instead of Streamlit's default (which used
to show the filename "app" as the sidebar label).
"""
